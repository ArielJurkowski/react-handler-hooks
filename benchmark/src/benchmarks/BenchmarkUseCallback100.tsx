...
const BenchmarkUseCallbackDeps10: FC<BenchmarkProps> = props => {
  const tools = useBenchmark(props);

  const dep: number = Math.floor(tools.renderCount / 100) % 2;
...
export default memo(BenchmarkUseCallbackDeps10);
